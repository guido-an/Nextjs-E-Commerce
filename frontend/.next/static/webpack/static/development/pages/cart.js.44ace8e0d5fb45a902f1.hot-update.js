...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Cart, [{
    ...
    value: function filterVendorRinci() {
      var vendorRinciProducts = this.props.productsInCart.filter(function (product) {
        return product.vendor_name == "Rinci";
      });
      var vendorRinci = vendorRinciProducts;
      this.setState({
        vendorRinci: vendorRinci
      });
    } // filterVendorBjt() { 
    //   let vendorBjtProducts = this.props.productsInCart.filter(product => {
    //     return product.vendor_name == "Bjt"
    //   })
    //   let vendorBjt = vendorBjtProducts
    //   this.setState({
    //     vendorBjt: vendorBjt
    //   })
    // }
    ...
    key: "filterVendor",
    value: function filterVendor(vendorName) {
      var vendorBjtProducts = this.props.productsInCart.filter(function (product) {
        return product.vendor_name == vendorName;
      });
      var vendorBjt = vendorBjtProducts;
      this.setState({
        vendorBjt: vendorBjt
      });
    }
...
//# sourceMappingURL=cart.js.44ace8e0d5fb45a902f1.hot-update.js.map