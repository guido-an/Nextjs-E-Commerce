    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10__["default"])(_this), "updateCart", function (product) {
      for (var i = 0; i < _this.state.productsInCart.length; i++) {
        if (_this.state.productsInCart[i].name == product.name) {
          ...
          var _p = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_5__["default"])({}, product);

          _p.id = Math.random();
          var productsInCart = [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__["default"])(_this.state.productsInCart), [_p]);
...
//# sourceMappingURL=_app.js.cc2655be43a4d1c775ba.hot-update.js.map